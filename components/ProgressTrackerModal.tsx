          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900 dark:text-white">
                {language === 'en' ? 'My Learning Progress & Badges' : 'Kemajuan Belajar & Lencana'}
              </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800">
                  ...
                  <div className="text-2xl font-black font-mono text-sky-600 dark:text-sky-400 mt-1">
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                {!showResetConfirm ? (
                  <button
                    ...
                    className="text-xs font-medium text-rose-500 hover:underline flex items-center gap-1.5"
                  >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="px-3 py-1 rounded-lg bg-slate-200 dark:bg-slate-700 text-xs"
                    >
          ...
          {activeTab === 'certificate' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-slate-50 dark:bg-slate-800/40 rounded-xl border border-slate-200 dark:border-slate-800">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="px-3 py-1.5 rounded-lg bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-xs font-semibold text-slate-900 dark:text-white w-full sm:w-64"
                  />
                </div>

                <button
                  onClick={handlePrintCertificate}
                  className="px-4 py-2 rounded-xl bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 hover:bg-sky-600 dark:hover:bg-sky-500 text-xs font-bold flex items-center gap-2 shadow-xs cursor-pointer self-end sm:self-auto"
                >
              ...
              <div
                ...
                className="relative bg-white text-slate-900 p-8 sm:p-12 rounded-2xl border-4 border-double border-amber-600/40 shadow-xl space-y-6 text-center"
              >
                ...
                <div>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-serif font-black text-slate-900 mt-2 tracking-wide">
                ...
                <div className="py-2">
                  ...
                  <div className="text-2xl sm:text-3xl font-serif font-bold text-slate-900 mt-1 border-b-2 border-slate-200 inline-block pb-1 px-8">
                    {userName || 'Candidate'}
                  </div>
                </div>
